...
class StudioView(TemplateView):
    """
    GET /api/v1/health/studio/

    Serves the new Archi3D Design Studio professional interface.
    The main design experience for users.
    """

    template_name = "health/studio.html"
